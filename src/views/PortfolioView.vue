            ...
            <div v-for="item in items" :key="item.id">
              <div
                ...
                <div class="flex h-12 w-12 items-center justify-center p-0 h-full w-full lg:p-0 zoom-in">
                  ...
                  :src="'/AminPortfolio/img/portfolio-' + item.imageUrl + '.png'">                  
                </div>
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-justify text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm">
                    {{ item.status }}</div>
      ...
      items: [
        {
          ...
          name: 'MatriXpert',
          imageUrl: 'matrixpert',
          status: 'My final year project, MatriXpert is an interactive mobile learning application designed to help students studying the fundamental of matrix algebra. This application integrates multiple learning tools, including guided lessons, AI-powered chatbot assistance, matrix calculators, and interactive quizzes to enhance users\' understanding of matrix concepts.',
          tech: 'Java, SQLite',
          github: 'null',
          demo: 'null'
        },
        {
          id: 2,
          name: 'AI Drawing Calculator',
          imageUrl: 'AICalc',
          status: 'AI Drawing Calculator is an intelligent web application that allows users to draw or handwrite mathematical equations directly on a canvas. Using advanced AI-based handwriting recognition and math-solving engines, the app translates handwritten input into digital math expressions and provides instant solutions with a single click',
          tech: 'Python, React',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          imageUrl: 'colorGame',
          status: 'Color Memory Game is a fast-paced mobile memory challenge where users must repeat randomly generated color sequences within a limited time. Designed for simplicity and fun, the game pushes players to think quickly and recall patterns accurately before the timer runs out.',
          tech: 'Java, SQLite',
          github: 'null',
          demo: 'null'
        },
