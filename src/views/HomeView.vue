<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Muhammad Nur Amin</h1>
      <div class="py-2">
        <h1
  ...
  src= 'https://i.ibb.co/gbRfLpJP/amin.jpg'/>
    </div>
  </main>

  <!-- Contact Information Section -->
  <section class="mt-16 md:mt-20 px-10 pb-20">
    <div class="max-w-6xl mx-auto">
      <h2 class="text-3xl font-bold text-center text-white mb-8 fadein-up">Get In Touch</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        
        <!-- Email -->
        <div class="contact-card fadein-bot">
          <div class="flex items-start space-x-4">
            ...
            <div class="flex-1 min-w-0">
              <h3 class="text-amber-200 font-semibold">Email</h3>
              <a href="mailto:muhdnuramin002@gmail.com" class="text-gray-300 hover:text-white transition-colors break-all text-sm">
                muhdnuramin002@gmail.com
              </a>
            </div>
          </div>
        </div>
        ...
        <!-- Phone -->
        <div class="contact-card fadein-bot fadein-1">
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h3 class="text-amber-200 font-semibold">Phone</h3>
              <a href="tel:+60168464235" class="text-gray-300 hover:text-white transition-colors">
                +60 16-846 4235
              </a>
            </div>
          </div>
        ...
        <!-- Location -->
        <div class="contact-card fadein-bot fadein-2">
          <div class="flex items-center space-x-4">
            <div class="contact-icon">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div>
              <h3 class="text-amber-200 font-semibold">Location</h3>
              <p class="text-gray-300">Shah Alam, Selangor</p>
            </div>
          </div>
        </div>
...
.contact-card:hover {
  ...
  box-shadow: 0 10px 30px rgba(255, 219, 112, 0.1);
}
